...
class Test_FileStorage_instant(unittest.TestCase):
    ...
    def test_FileStorage_objects_private_dict(self):
...
class Test_FileStorage_methods(unittest.TestCase):
    """Unittests for testing the "FileStorage" class's methods"""
